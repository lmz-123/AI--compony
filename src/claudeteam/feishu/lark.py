...
def subprocess_env() -> dict[str, str]:
    ...
    if app_id and app_secret:
        # The Channel SDK sidecar authenticates directly with the app pair; it
        # does not need our optional tenant-token prefetch. Keep ingress alive
        # when that fetch is temporarily unavailable.
